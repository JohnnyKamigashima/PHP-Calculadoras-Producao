...
for (var y = 0; y < Ncanais; y++) {
    ...
    if (upperName.indexOf("BLACK") != -1) {pretoName='Black';}
else if (upperName.indexOf("PRETO") != -1) {pretoName='Preto';}
...
if (pretoName != '') {changeColor(pretoName, 0, 0, 0, 80, 0);} //Set black to 80%

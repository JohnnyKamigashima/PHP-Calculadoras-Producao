  ...
  <div class="cells">
      ...
      <div class="linha_resposta">
          ...
          <div class="col-2 align-self-center pl-5">
              <img src="https://cdn4.iconfinder.com/data/icons/ionicons/512/icon-clipboard-512.png" alt="Botão de copiar resultado para a Área de colagem" class="icon" onclick="clip_altoem.copyToClipboard(document.getElementById('altoemA').value+' mm2')">
          </div>
      </div>
      <div class="linha_resposta">
          <div class="col-7 align-self-center">
          ...
          <div class="col-2 align-self-center pl-5">
              <img src="https://cdn4.iconfinder.com/data/icons/ionicons/512/icon-clipboard-512.png" alt="Botão de copiar resultado para a Área de colagem" class="icon" onclick="clip_altoem.copyToClipboard(document.getElementById('largF').value+' mm')">
          </div>
      </div>
      <div class="input-group ">
          <div class="linha_resposta">
              ...
              <div class="col-2 align-self-center pl-5">
                  <img src="https://cdn4.iconfinder.com/data/icons/ionicons/512/icon-clipboard-512.png" alt="Botão de copiar resultado para a Área de colagem" class="icon" onclick="clip_altoem.copyToClipboard(document.getElementById('largMx').value+' mm')">
              </div>
          </div>
      </div>
